%% ----------------------------------------------------------------------------------
%% Standalone file for Problem Set 3 - FINAL RECOMMENDED CODE
%% This uses 'atbegshi' to eliminate any blank page generated at the start.
%% ----------------------------------------------------------------------------------

\documentclass[preprint,12pt,authoryear]{elsarticle}

% --- Files required by the main document (MUST be present) ---
\input{instr-preamble}
\input{instr-mathsymbols}

% --- FIX: Add the 'atbegshi' package and command to discard the first page ---
\usepackage{atbegshi}
% This command forces LaTeX to discard the very first page it tries to output.
...
% ---------------------------------------------------
% START OF instr-PS3.tex CONTENT
% ---------------------------------------------------

% Set the section counter exactly as it was defined in instr-PS3.tex
